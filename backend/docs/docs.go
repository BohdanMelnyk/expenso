...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/expenses/import/bank/confirm": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Transaction and expense data",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateExpenseFromBankRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/expenses/import/bank/preview": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "CSV format (e.g., 'haspa_credit')",
                        "name": "format",
                        "in": "formData",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.BankImportPreviewResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/expenses/parse": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Natural language expense text",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ParseExpenseRequestDTO"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.ParsedExpenseResponseDTO"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dto.SnapshotResponseDTO"
                            }
                        }
                    },
                    "500": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateSnapshotRequestDTO"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "dto.BankImportPreviewResponse": {
            ...
            "properties": {
                ...
                "transactions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.BankTransactionDTO"
                    }
                }
            }
        },
        ...
        "dto.CreateExpenseFromBankRequest": {
            "type": "object",
            "required": [
                "expense_data",
                "transaction_data"
